...
target: bilateral_filter skin_extractor edge_sharpen skin_whiten cu_bilateral_filter cuda_bilateral_filter cuda_bilateral_filter_tex

bilateral_filter: bilateral_filter.o
	$(CXX) -o $@ -fopenmp $+ $(LDFLAGS) $(LIBRARIES)
skin_extractor: extract_skin_region.o
	$(CXX) -o $@ -fopenmp $+ $(LDFLAGS) $(LIBRARIES)
edge_sharpen: edge_sharpen.o
	$(CXX) -o $@ -fopenmp $+ $(LDFLAGS) $(LIBRARIES)
skin_whiten: skin_whitenning.o
	$(CXX) -o $@ -fopenmp $+ $(LDFLAGS) $(LIBRARIES)
cu_bilateral_filter: cu_bilateral_filter.o cuda_common.o
	$(NVCC) $(LDFLAGS) $(GENCODE_FLAGS) -o $@ $+ $(LIBRARIES)
cuda_bilateral_filter: cuda_bilateral_filter.o cuda_common.o
	$(NVCC) $(LDFLAGS) $(GENCODE_FLAGS) -o $@ $+ $(LIBRARIES)
cuda_bilateral_filter_tex: cuda_bilateral_filter_tex.o cuda_common.o
	$(NVCC) $(LDFLAGS) $(GENCODE_FLAGS) -o $@ $+ $(LIBRARIES)
...
clean:
	-rm -f *.o
	-rm -f bilateral_filter
	-rm -f skin_extractor
	-rm -f edge_sharpen
	-rm -f cu_bilateral_filter
	-rm -f cuda_bilateral_filter
	-rm -f cuda_bilateral_filter_tex
